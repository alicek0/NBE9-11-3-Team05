...
class AnimalService(
    ...
    fun getAnimals(region: String?, kind: String?, kindFullNm: String?, stateGroup: Int?, pageable: Pageable): Page<AnimalRes> {
        // 예외처리 (페이지 번호 음수)
        ...
        val animalPage: Page<Animal> = animalRepository.findAnimalsWithFilter(region, kind, kindFullNm, stateGroup, pageable)
